RSpec.describe 'As a visitor' do
  it 'see list of pets from specific shelter including each pet image, name, approx age, and sex' do
    ...
    pet3 = Pet.create!(name: 'Leo', approx_age: 7, sex: 'male', image: "", shelter_id: shelter.id)
    ...
    expect(page).to have_xpath("//img[@src = 'https://s3.amazonaws.com/cdn-origin-etr.akc.org/wp-content/uploads/2017/11/13001403/Australian-Cattle-Dog-On-White-03.jpg' and @alt='Australian Cattle Dog']")
